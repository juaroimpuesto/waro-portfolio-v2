  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white selection:bg-green-500/30">
      ...
      <section id="contact" className="max-w-7xl mx-auto px-6 py-24 border-t border-white/5 text-center">
        ...
        <div className="mt-16">
          <button className="px-10 py-4 bg-green-500 text-black font-black rounded-full hover:bg-white transition-all transform hover:scale-105 uppercase text-xs tracking-widest">
            Check Availability
          </button>
        </div>
      </section>
